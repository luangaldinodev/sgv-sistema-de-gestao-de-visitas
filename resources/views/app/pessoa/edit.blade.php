...
@section('conteudo')
    ...
    <div class="">
        <section class="w-5xl mx-auto bg-white mt-10 py-6 px-8 rounded-lg">
            <h2 class="text-sky-950 font-bold text-4xl">Atualizar Pessoa</h2>
            ...
            <form action="{{ route('pessoa.store') }}" method="post"
                ...
                <div class="col-start-1 col-end-4">
                    ...
                    <input type="text" name="nome_completo" id="nome_completo" placeholder="Nome completo do cidadão" value="{{ $pessoa->nome_completo }}"
                ...
                <div class="col-start-2 col-end-3">
                    ...
                    <input type="date" name="data_cadastro" id="data_cadastro" placeholder="(00) 00000-0000" value="{{ $pessoa->data_cadastro }}"
                        class="mb-1 w-full p-2 text-sky-950 font-semibold border border-neutral-500/20 bg-neutral-100 rounded-sm outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-500">
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="endereço" id="endereço" placeholder="Rua, número, bairro" value="{{ $pessoa->endereço }}"
                        class="mb-1 w-full p-2 text-sky-950 font-semibold border border-neutral-500/20 bg-neutral-100 rounded-sm outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-500">
                </div>
                    ...
                    <div class="flex gap-4">
                        <label for="familia_unipessoal" class="flex-1 cursor-pointer">
                            <input type="radio" name="tipo_familia" id="familia_unipessoal" value="Unipessoal"
                                class="hidden peer" {{ $pessoa->tipo_familia == 'Unipessoal' ? 'checked' : ''}}>
                            <div
                   ...
                   text-sm font-medium transition-all">
                        ...
                        <label for="familia_familiar" class="flex-1 cursor-pointer">
                            <input type="radio" name="tipo_familia" id="familia_familiar" value="Familiar"
                                class="hidden peer" {{ $pessoa->tipo_familia == 'Familiar' ? 'checked' : ''}}>  
                            <div
                                class="flex items-center justify-center h-12 border-2 border-neutral-300 rounded-lg
                   peer-checked:border-sky-500 peer-checked:bg-sky-50
                   text-sm font-medium transition-all">
                    ...
                    <div class="flex gap-4">
                        <label for="cadastro_novo" class="flex-1 cursor-pointer">
                            <input type="radio" name="tipo_cadastro" id="cadastro_novo" value="Novo" class="hidden peer"
                                {{ $pessoa->tipo_cadastro == 'Novo' ? 'checked' : ''}}>
                            <div
                                class="flex items-center justify-center h-12 border-2 border-neutral-300 rounded-lg
                   peer-checked:border-sky-500 peer-checked:bg-sky-50
                   text-sm font-medium transition-all">
                        ...
                        <label for="cadastro_atualizacao" class="flex-1 cursor-pointer">
                            <input type="radio" name="tipo_cadastro" id="cadastro_atualizacao" value="Atualização"
                                class="hidden peer" {{ $pessoa->tipo_cadastro == 'Atualização' ? 'checked' : ''}}>
                            <div
                                class="flex items-center justify-center h-12 border-2 border-neutral-300 rounded-lg
                   peer-checked:border-sky-500 peer-checked:bg-sky-50
                   text-sm font-medium transition-all">
                ...
                <div class="col-span-4">
                    ...
                    <textarea name="observacoes" id="observacoes" placeholder="Descreva informações relevantes sobre a visita domiciliar ou situação da familía..." cols="30" rows="5" class="mb-1 w-full p-2 text-sky-950 font-semibold border border-neutral-500/20 bg-neutral-100 rounded-sm outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-500">{{ $pessoa->observacoes }}</textarea>
                </div>
